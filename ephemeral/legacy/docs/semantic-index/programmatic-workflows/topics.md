...
- **Context, information, and semantic indexing:**
  [context-and-indexing](routes/context-and-indexing/index.md).
- **Program shape versus input data:** [program-input](routes/program-input/index.md).
- **Roles, supervision, and evaluation:**
  [roles-and-evaluation](routes/roles-and-evaluation/index.md).
- **Current shipped contract versus proposed direction:**
  [status-and-contract](routes/status-and-contract/index.md).
