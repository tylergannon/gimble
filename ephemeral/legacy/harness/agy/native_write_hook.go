...
// confirmed, to use the same TargetFile key.
//
...
//
// The hook is artifact-aware, not a blanket path-based deny: live testing
// of the failure
...
// against real agy 1.1.15 (captured via a debug hook that logged its own stdin;
