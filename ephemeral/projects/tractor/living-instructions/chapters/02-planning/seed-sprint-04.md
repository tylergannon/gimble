# Seed: add a greeting script

Add one executable POSIX shell script named `greet.sh` at the repository root.
Running it with no arguments prints one greeting followed by a newline and has
