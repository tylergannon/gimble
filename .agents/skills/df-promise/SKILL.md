...
```bash
PROMISE_SKILL_DIR="$(find .agents ~/.agents ~/.codex -maxdepth 5 -type d -name df-promise 2>/dev/null | head -1)"
...
1. Read `AGENTS.md`, relevant architecture/testing docs, existing CI, README
