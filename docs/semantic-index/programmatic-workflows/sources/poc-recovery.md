# Source leaf: recovered Go POC

## Purpose

Locate the preserved implementation before designing a Go library; separate
the unmerged POC, historical proof reports, and proposed follow-up work.
...
- For “where did the POC go?”, read the recovery source at lines 44-74.
