...
func newRootCommand() *cobra.Command {
	...
	root.AddCommand(newAskCommand(), newAnswerCommand(), newValidateCommand(), newRunCommand(), newPrintSchemaCommand(), newMCPCommand(), newMCPRunnerCommand(), newPluginCommand())
	return root
}
